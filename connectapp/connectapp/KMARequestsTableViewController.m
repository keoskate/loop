...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    requestCell.userPic.layer.borderWidth = 2;
    requestCell.userPic.layer.borderColor = [UIColor whiteColor].CGColor;
    requestCell.userPic.layer.cornerRadius = 30.0f;
    requestCell.userPic.clipsToBounds = YES;
